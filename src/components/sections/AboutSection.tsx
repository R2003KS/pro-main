                    ...
                    <AnimationContainer customClassName="w-full flex flex-col">
                        ...
                        <div className="w-full mb-8 space-y-5">
                            ...
                            <motion.p
                                ...
                                className="text-base leading-8 text-neutral-200"
                            >
                                I&apos;m also curious about Android learning, which is like teaching computers to learn and do smart things. I dream of building smart systems that work hand-in-hand with people, making tech a helpful companion in our daily lives.
                            </motion.p>
                            <motion.p
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
